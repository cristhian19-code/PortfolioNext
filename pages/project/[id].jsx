                ...
                isMounted ? (
                    <Box padding={8} width={['100%']}>
                        ...
                        <Flex gap={5} marginTop={5}>
                            <Button onClick={() => { handleLink('/proyectos') }} _hover={{ bgColor: 'blue.400' }} bgColor={'blue.500'}>Volver</Button>
                            <Button onClick={() => { handleLink(data.link) }} _hover={{ bgColor: 'teal.400' }} bgColor={'teal.500'}>Ir <ExternalLinkIcon marginLeft={2} fontSize={15} /></Button>
                        </Flex>
                    </Box>
                ) : null
            }
